...
-->
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <?php if(isset($_SESSION['level']) == 0) //check if user is a user and display buttons
    {
    ?>
    ...
    <?php } elseif(isset($_SESSION['level']) == 1) //check if user is an admin and display buttons
    {
    ?>
                            <li class="scroll-to-section"><a href="sobre_nos.php">Quem somos</a></li>
                            <li class="scroll-to-section"><a href="videos.php">Treinos</a></li>
