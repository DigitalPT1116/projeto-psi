    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_customer.php?operation=create" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Adicionar</a>
            </div>
        </div>
    </div>
...
?>>Desc</option>
    ...
    <div id="export-section">
        <a href="export_customers.php"><button class="btn btn-sm btn-primary">Exportar dados em CSV <i class="glyphicon glyphicon-export"></i></button></a>
    </div>
