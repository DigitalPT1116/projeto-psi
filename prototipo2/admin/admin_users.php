...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_admin.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Adicionar</a>
            </div>
        </div>
    </div>
    ...
    {
        echo '<div class="alert alert-info">Eliminado com sucesso</div>';
    }
    ?>
    ...
    <table class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                <th width="5%">ID</th>
                <th width="45%">Nome</th>
                <th width="40%">Tipo de utilizador</th>
                    ...
                    <form action="delete_user.php" method="POST">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p>Tens acerteza que desejas eliminar esta conta?</p>
                            </div>
