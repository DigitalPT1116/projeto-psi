...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!empty($row['user_name'])) {
		...
		$_SESSION['failure'] = "Nome já existe";
	...
	if ($stat) {
		$_SESSION['success'] = "Conta de administrador atualizada";
	} else {
		$_SESSION['failure'] = "Falha ao atualizar a conta de administrador : " . $db->getLastError();
	}
...
<div id="page-wrapper">
    ...
    <div class="row">
     <div class="col-lg-12">
            <h2 class="page-header">Atualizar administrador</h2>
        </div>
