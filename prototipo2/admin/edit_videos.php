...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    ...
    $stat = $db->update('videos', $data_to_update);

    if($stat)
    {
        $_SESSION['success'] = "Video atualizado com sucesso!";
...
<div id="page-wrapper">
    <div class="row">
        <h2 class="page-header">Atualizar Video</h2>
    </div>
    <!-- Flash messages -->
    <?php
...
<form class="" action="" method="post" enctype="multipart/form-data" id="contact_form">
        ...
        <?php
            ...
            require_once('./forms/videos_form.php'); 
        ?>
    </form>
</div>
